...
1. [Website Visitors](#1-website-visitors)
...
A cookie is a string of information that a website stores on a visitor's computer, and that the visitor's browser provides to the website each time the visitor returns. Borealis Logistics uses cookies to help identify and track visitors, their usage of https://www.borealislogistics.com, and their website access preferences. Visitors who do not wish to have cookies placed on their computers should set their browsers to refuse cookies before using Borealis Logistics's websites, with the drawback that certain features of Borealis Logistics's websites may not function properly without the aid of cookies.
